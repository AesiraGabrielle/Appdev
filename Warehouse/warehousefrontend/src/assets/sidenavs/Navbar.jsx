      ...
      <div className="container-fluid">
        <div className="row align-items-center justify-content-between"> 
          <div className="col-auto">
            <img src="src\assets\images\logo.png" alt="user" className="logo" onClick={redirectToAboutPage} />
          </div>
          <div className="col-auto">
            ...
            <form className="form-inline d-flex justify-content-end" role="search"> 
              <div className="input-group">
                ...
                <div className="input-group-append">
                  <button className="search btn btn-outline-dark" type="submit" style={{marginRight:'10px'}}> Search</button>
                </div>
              </div>
            </form>
          </div>
