                ...
                <div className="user_card">
                    ...
                    <div className="mt-4">
                        <div className="d-flex justify-content-center links" style={{marginTop:'30px'}}>
                            Don&apos;t have an account? <a href="#" className="ml-2" style={{color:'blue'}} onClick={redirectToRegisterPage}> Sign Up</a>
                        </div>
                        <div className="d-flex justify-content-center links">
                            <a href="#" onClick={redirectToAdminLoginPage} style={{color:'blue'}}>Are you an Admin?</a>
                        </div>
                    </div>
                </div>
            </div>
